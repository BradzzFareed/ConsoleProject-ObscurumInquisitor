                    ...
                    else if (!currentState.Flags.ContainsKey("met_arthur"))
                    {
                        ...
                        if (currentState.Flags.ContainsKey("game_over_route"))
                        {
                            ...
                            while (true)
                            {
                                ...
                                char decision = Convert.ToChar(Console.ReadLine().ToLower());
                                switch (decision)
                                {
                                    case 'y':
                                        LoadGame();
                ...
                try
                {
                    if (currentState.Flags.ContainsKey("chapter_2_started"))
                    {
                        ...
                        again9:
                            ...
                            GameMenu.TypingAnimation("\r\nDetective Zero : Erebus, why won’t he speak?");
                            Console.ReadKey(intercept: true);
                            ...
                            Console.Clear();
                            GameMenu.TypingAnimation("\r\nDetective Zero : Erebus, what time are shadows often seen?");
                            Console.ReadKey(intercept: true);
                            ...
                            GameMenu.TypingAnimation("\r\nDetective Zero : I’m an Detective ma’am, just want to ask you some questions regarding these shadows");
                            Console.ReadKey(intercept: true);
                            ...
                            GameMenu.TypingAnimation("\r\nDetective Zero : I want to ask you some questions about the shadow ma’am, will that be ok?");
                            Console.ReadKey(intercept: true);
                            
                            GameMenu.TypingAnimation("\r\nGrandma Quin : Of course go ahead");
                            Console.ReadKey(intercept: true);
                        
                            GameMenu.TypingAnimation("\r\nDetective Zero : Did you see any shadow?");
                            Console.ReadKey(intercept: true);
                    ...
                    else if (!currentState.Flags.ContainsKey("met_pale_man"))
                    {
                        if (currentState.Flags.ContainsKey("delayed_action"))
                        {
                            ...
                            GameMenu.TypingAnimation("\r\n*While talking to Erebus, the man suddenly stood and pounced on you!*");
                            Console.ReadKey(intercept: true);
                            GameMenu.TypingAnimation("His name's Mr. Mark, he lost his wife and daughter from the shadows that’s why he’s so pale, decimated that his family was taken away from him by these cursed entities. I guess his mind broke unable to accept wha
                ...
                try
                {
                    if (!currentState.Flags.ContainsKey("chapter_2.1_started"))
                    {
                        currentState.Flags["chapter_2.1_started"] = true;
                            ...
                            GameMenu.TypingAnimation("\r\nDetective Zero : what happened outside Arthur");
                        ...
                        again10:
                            ...
                            switch (choice10)
                            {
                                case '1':
                                    Console.Clear();
                                    GameMenu.TypingAnimation("\r\nDetective Zero: I’ll trust you, I hope you’re not lying to me");
                                    Console.ReadKey(intercept: true);
                ...
                try
                {
                    if (!currentState.Flags.ContainsKey("chapter_2.3_started"))
                    {
                        ...
                        ConsoleKey menu;
                            ...
                            GameMenu.TypingAnimation("\r\nDetective Zero : I see it!");
                            Console.ReadKey(intercept: true);
                            
                            GameMenu.TypingAnimation("\r\nYou continued walking*");
                            Console.ReadKey(intercept: true);
                            
                            GameMenu.TypingAnimation("\r\nDetective Zero : Huh, what is this black smoke");
                            Console.ReadKey(intercept: true);
                            ...
                            GameMenu.TypingAnimation("\r\nDetective Zero : They look like phases of moon, The New Moon, Crescent Moon, Half Moon, Gibbous Moon and Full Moon");
                            Console.ReadKey(intercept: true);
                            ...
                            Console.Clear();
                            GameMenu.TypingAnimation("\r\nDetective Zero : We should roam around then");
                            Console.ReadKey(intercept: true);
                            ...
                            GameMenu.TypingAnimation("\r\nAnonymous voice : What if these shadows are those captured villagers. God I hope not.");
                            Console.ReadKey(intercept: true);

                            GameMenu.TypingAnimation("\r\nDetective Zero : I've been thinking about that. Well we don't really have any other way to take the symbols from them. Let's just  in the tree.hope their bodies are still there");
                            Console.ReadKey(intercept: true);
